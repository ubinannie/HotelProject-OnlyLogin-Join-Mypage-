...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#idCheck").on('click', function(){
			console.log('click');
			window.open("./idcheckForm.do?idcheckForm.jsp","idcheckForm","width=400, height=300");
		}); 
		...
		$("#reg").on('click', function(){
			...
			// document.frm.action = "./myPage.do?mypageOk.jsp";
			document.frm.action = "./register.do?registerOk01.jsp";
...
<body>
	...
	<div id="regDiv">
		...
		<form name="frm" id="frm" action = './register.do'>
