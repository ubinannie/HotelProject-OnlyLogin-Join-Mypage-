...
//----------------------------------------------------------------------------------------------	
		...
		/*
		 * AdminVO vo = new AdminVO(); vo.setAd_password("919381yc9@@");
		 * vo.setAd_name("수정"); vo.setAd_tel("010-9999-9999"); vo.setAd_id("111222");
		 * 
		 * System.out.println(dao.updateData(vo)); // dao 문제 없네요
		 */
	}
